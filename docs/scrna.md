...
| `--reads-umis-ratio-cutoff` | `10` | Minimum `reads / UMIs` ratio per corrected cell barcode during cell-level QC. |
| `--reads-cutoff` | `10` | Minimum read support per molecule retained after QC. |
